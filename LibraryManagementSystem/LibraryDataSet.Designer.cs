...
namespace LibraryManagementSystem {
    ...
    public partial class LibraryDataSet : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public BooksRow AddBooksRow(string Serial, string BookTitle, string Department, string Price) {
        ...
        public partial class BooksRow : global::System.Data.DataRow {
            ...
            public string Department {
                get {
                    try {
                        return ((string)(this[this.tableBooks.DepartmentColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Department\' in table \'Books\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableBooks.DepartmentColumn] = value;
                }
            }
            ...
            public bool IsDepartmentNull() {
                return this.IsNull(this.tableBooks.DepartmentColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public void SetDepartmentNull() {
                this[this.tableBooks.DepartmentColumn] = global::System.Convert.DBNull;
            }
...
namespace LibraryManagementSystem.LibraryDataSetTableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM `Books` WHERE ((`Id` = ?) AND ((? = 1 AND `Serial` IS NULL) OR (`Serial` = ?)) AND ((? = 1 AND `BookTitle` IS NULL) OR (`BookTitle` = ?)) AND ((? = 1 AND `Department` IS NULL) OR (`Department` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Books` (`Serial`, `BookTitle`, `Department`, `Price`) VALUES (?, ?, " +
                "?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Books` SET `Serial` = ?, `BookTitle` = ?, `Department` = ?, `Price` = ? WHERE ((`Id` = ?) AND ((? = 1 AND `Serial` IS NULL) OR (`Serial` = ?)) AND ((? = 1 AND `BookTitle` IS NULL) OR (`BookTitle` = ?)) AND ((? = 1 AND `Department` IS NULL) OR (`Department` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)))";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Serial, BookTitle, Department, Price FROM Books";
        ...
        public virtual int Delete(int Original_Id, string Original_Serial, string Original_BookTitle, string Original_Department, string Original_Price) {
        ...
        public virtual int Insert(string Serial, string BookTitle, string Department, string Price) {
            if ((Serial == null)) {
        ...
        public virtual int Update(string Serial, string BookTitle, string Department, string Price, int Original_Id, string Original_Serial, string Original_BookTitle, string Original_Department, string Original_Price) {
            if ((Serial == null)) {
